                  ...
                  Container(
                    ...
                    child: Column(children: [
                      ...
                      (Get.find<SplashController>().configModel!.toggleStoreRegistration! && !ResponsiveHelper.isDesktop(context)) ? PortionWidget(
                        icon: Images.storeIcon, title: 'Login Store', route: '/login/store', onTap: () async {
                          final url = Uri.parse('https://admin.foodweb.com.ng/login/store');
                      ...
                      (Get.find<SplashController>().configModel!.toggleStoreRegistration! && !ResponsiveHelper.isDesktop(context)) ? PortionWidget(
                        icon: Images.dmIcon, title: 'Login Driver/Rider', hideDivider: true, route: RouteHelper.DriverLogin,
                      ) : const SizedBox(),
                    ]),
                  )
                ]) : const SizedBox(),
